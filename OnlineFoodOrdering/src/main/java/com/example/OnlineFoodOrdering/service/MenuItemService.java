...
public class MenuItemService {
    ...
    public List<MenuItem> findByCategory(MenuItem.FoodCategory category) { 
        return menuItemRepository.findByCategory(category); 
    }

    public Page<MenuItem> findByCategory(MenuItem.FoodCategory category, Pageable pageable) { 
        return menuItemRepository.findByCategory(category, pageable); 
    }

    public List<MenuItem> findByPriceBetween(Double min, Double max) { 
